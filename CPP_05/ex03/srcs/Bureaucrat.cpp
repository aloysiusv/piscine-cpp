...
/*   Updated: 2022/11/03 19:04:59 by lrandria         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				Bureaucrat::signForm(AForm &form) {
	...
	if (form.getIsSigned() == true)
		...
		std::cout << _name << " couldn't sign " << form.getName() 
				  << "because he/she has smelly feet.\n";
}

void	Bureaucrat::executeForm(AForm const &form) const {
	
	if (form.getIsSigned() == false)
		std::cout << "Can't execute unsigned form " << form.getName() << std::endl;
	else if (_grade > form.getGradeToExec())
		std::cout << _name << " cannot execute " << form.getName() << " because " << _name << " needs a promotion!\n";
	else
